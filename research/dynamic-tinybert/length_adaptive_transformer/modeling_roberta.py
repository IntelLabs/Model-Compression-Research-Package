...
# 
# This file is based on modeling_bert.py from https://github.com/clovaai/length-adaptive-transformer
# with TinyRoberta added
...
class TinyRobertaForQuestionAnswering(RobertaPreTrainedModel):
    _keys_to_ignore_on_load_unexpected = [r"pooler"]
    _keys_to_ignore_on_load_missing = [r"position_ids"]
    ...
    def forward(
        ...
        hidden_states_for_tiny = outputs.hidden_states
        if hidden_states_for_tiny is not None and is_student:
            tmp = []
            for s_id, sequence_layer in enumerate(hidden_states_for_tiny):
                tmp.append(self.fit_dense(sequence_layer))
            hidden_states_for_tiny = tmp
        ...
        return QuestionAnsweringModelOutput(
            ...
            start_logits=start_logits,
            end_logits=end_logits,
            hidden_states=outputs.hidden_states_for_tiny,
            attentions=outputs.attentions,
        )
